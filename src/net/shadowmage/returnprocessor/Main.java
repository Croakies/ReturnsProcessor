...
public class Main 
{
  ...
  {    
    ...
    config.load(fis);
    String remoteExcelFileName = config.getProperty("remoteExcelFile");
    System.out.println("remote: "+remoteExcelFileName);
    remoteExcelFile = new File(config.getProperty("remoteExcelFile"));
    fis.close();
    gui = new Gui();
    try
    {
